...
const Locations = () => {
    ...
    return (
        <div className="space-y-8 animate-fadeIn">
            {/* Header */}
            <div>
                <h1 className="text-3xl font-bold text-[#0f172a] mb-2">Locations</h1>
            ...
            <Card className="shadow-sm rounded-xl border border-gray-100">
                <div className="flex flex-col md:flex-row gap-4 justify-between">
                    ...
                    <button className="flex items-center gap-2 px-4 py-2.5 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 hover:border-[#0f172a] transition-all">
                        <Filter size={20} />
                        <span>Filter</span>
                    </button>
                </div>
                                ...
                                <tr key={loc.id} className="hover:bg-gray-50 transition-colors">
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="flex items-center">
                                            <div className="flex-shrink-0 h-10 w-10 bg-[#0f172a]/5 rounded-lg flex items-center justify-center">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div className="w-24 h-1.5 bg-gray-200 rounded-full mt-1">
                                            <div
                                                className="h-1.5 bg-[#0f172a] rounded-full"
